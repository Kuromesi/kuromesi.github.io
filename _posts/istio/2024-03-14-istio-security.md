...
> [Istio 中的证书管理方式介绍](https://jimmysong.io/blog/istio-certificates-management/)
> 
> [将 Istio 纳入信任链：使用现有 PKI 作为信任根](https://lib.jimmysong.io/blog/istio-trust/)
...
>
> [通过实例理解Go Web身份认证的几种方式](https://www.51cto.com/article/771056.html)
