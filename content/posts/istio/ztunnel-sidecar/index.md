...
description: "将 Ztunnel 作为 Pod 级代理实现超大规模 xDS 性能优化"
date: 2026-02-27T10:00:00+08:00
categories: [Istio]
tags: [envoy, service mesh, ambient, ai generated]
---
...
!["传统的 Sidecar 模式"](img/traditional-istio.png)
...
!["Ambient 模式"](img/traditional-istio.png)
...
![image.png](img/ztunnel-sidecar-perf/cpu-envoy.png)

*   **ztunnel Sidecar：** 同样的负载下，ztunnel 模式下的 CPU 峰值仅为 **1.42**。

![image.png](img/ztunnel-sidecar-perf/cpu-ztunnel.png)
...
![image.png](img/ztunnel-sidecar-perf/mem-envoy.png)

*   **ztunnel Sidecar：** ztunnel 仅需感知必要的工作负载和服务信息，内存开销缩减至 **1.14 GiB**，资源节省率高达 **74%**。
    
![image.png](img/ztunnel-sidecar-perf/mem-ztunnel.png)
...
![image.png](img/ztunnel-sidecar-perf/time-envoy.png)


*   **ztunnel Sidecar：** 其推送时间仅为 **450ms** 左右，相对于 Envoy 代理推送和计算时间大大减少。
    
![image.png](img/ztunnel-sidecar-perf/time-ztunnel.png)
